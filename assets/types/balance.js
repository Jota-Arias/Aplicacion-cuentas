...
var refreshOperationTable = function (operations) {
    ...
    for (var _i = 0, operations_1 = operations; _i < operations_1.length; _i++) {
        ...
        editOp.setAttribute("href", "./editarOperacion.html?descriptionOp=" + operation.description + "&amountOp=" + operation.amount + "&typeOp=" + operation.type + "&categoryOp=" + operation.category + "&dateOp=" + operation.date);
    }
};
